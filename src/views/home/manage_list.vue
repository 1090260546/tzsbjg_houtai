  ...
  <div class="shebei_manage">
    ...
    <div class="page_content">
      ...
      >
        ...
        <el-table-column prop="list_1" label="配件名称"></el-table-column>
        <el-table-column prop="list_2" label="规格型号"></el-table-column>
        <el-table-column prop="list_3" label="配件ID"></el-table-column>
        <el-table-column prop="list_4" label="所属设备"></el-table-column>
        <el-table-column prop="list_5" label="设备型号"></el-table-column>
        <el-table-column prop="list_6" label="配件数量"></el-table-column>
        <el-table-column prop="list_7" label="备注"></el-table-column>
