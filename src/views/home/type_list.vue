  ...
  <div class="type_list">
    ...
    <div class="page_content">
      ...
      >
        ...
        <el-table-column prop="list_1" label="设备类型"></el-table-column>
        <el-table-column prop="list_2" label="设备类型编码"></el-table-column>
        <el-table-column prop="list_3" label="设备数量"></el-table-column>
        <el-table-column prop="list_4" label="备注"></el-table-column>
        <el-table-column prop="list_5" label="操作人"></el-table-column>
