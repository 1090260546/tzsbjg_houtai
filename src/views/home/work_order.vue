  ...
  <div class="worl_order">
    ...
    <div class="page_content">
      ...
      >
        ...
        <el-table-column prop="list_1" label="维修单号"></el-table-column>
        <el-table-column prop="list_2" label="设备名称"></el-table-column>
        <el-table-column prop="list_3" label="设备类型"></el-table-column>
        <el-table-column prop="list_4" label="设备编号"></el-table-column>
        <el-table-column prop="list_5" label="故障描述"></el-table-column>
        <el-table-column prop="list_6" label="提交人"></el-table-column>
        <el-table-column prop="list_7" label="处理状态"></el-table-column>
